...
resource "aws_api_gateway_method_settings" "v1_proxy_post_no_cache" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  stage_name  = aws_api_gateway_stage.api_gateway_dev.stage_name
...
resource "aws_api_gateway_method_settings" "v2_proxy_post_no_cache" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  stage_name  = aws_api_gateway_stage.api_gateway_dev.stage_name
...
resource "aws_api_gateway_method_settings" "generateid_no_cache" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  stage_name  = aws_api_gateway_stage.api_gateway_dev.stage_name
...
# Associate dev WAF with API Gateway dev stage
resource "aws_wafv2_web_acl_association" "api_gateway_dev" {
  resource_arn = aws_api_gateway_stage.api_gateway_dev.arn
