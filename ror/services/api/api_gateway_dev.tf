...
resource "aws_api_gateway_integration" "v1_organizations_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_integration" "v2_organizations_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_integration" "v1_organizations_id_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_integration" "v2_organizations_id_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_integration" "organizations_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_integration" "organizations_id_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_integration" "proxy_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_integration_response" "v1_organizations_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.v1_organizations.id
  http_method = aws_api_gateway_method.v1_organizations_get.http_method
...
resource "aws_api_gateway_integration_response" "v2_organizations_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.v2_organizations.id
  http_method = aws_api_gateway_method.v2_organizations_get.http_method
...
resource "aws_api_gateway_integration_response" "v1_organizations_id_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.v1_organizations_id.id
  http_method = aws_api_gateway_method.v1_organizations_id_get.http_method
...
resource "aws_api_gateway_integration_response" "v2_organizations_id_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.v2_organizations_id.id
  http_method = aws_api_gateway_method.v2_organizations_id_get.http_method
...
resource "aws_api_gateway_integration_response" "v1_heartbeat_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.v1_heartbeat.id
  http_method = aws_api_gateway_method.v1_heartbeat_get.http_method
...
resource "aws_api_gateway_integration_response" "organizations_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.organizations.id
  http_method = aws_api_gateway_method.organizations_get.http_method
...
resource "aws_api_gateway_integration_response" "organizations_id_get_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.organizations_id.id
  http_method = aws_api_gateway_method.organizations_id_get.http_method
...
resource "aws_api_gateway_integration_response" "proxy_dev" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
  resource_id = aws_api_gateway_resource.proxy.id
  http_method = aws_api_gateway_method.proxy.http_method
